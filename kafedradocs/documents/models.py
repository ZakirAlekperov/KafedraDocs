...
class Document(models.Model):
    ...
    document_type:str = models.CharField(max_length=100, help_text="Тип документа (учебный план, отчет, и т. д.)")
...
class DocumentVersion(models.Model):
    ...
    file:str = models.FileField(upload_to='documents_version/', help_text="Файл версии документа")
